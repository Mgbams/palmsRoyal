...
@section('title', 'More Space')

@section('content')
<div class="pages-stack more-space-container">
    <!-- page -->
    <div class="page about-hotel" id="page-home">
        ...
        <!--First div-->
        <div class="first-div-block" style="margin-top: 200px; display: flex;">
            <div style="width: 60%;">
                <img src="https://cdn.pixabay.com/photo/2020/04/17/12/24/bed-5054985__340.jpg" style="width: 100%; height: 100%;" />
            </div>
            <div style="width: 40%;">
                <h2 style="position: relative; right: 15vw; font-size: 5vw;">More Space, <br /> More Time</h2>
        ...
        <div style="margin-top: 100px; width: 100%; margin-bottom: 60px;">
            <div class="col-6 offset-4">
                <a href="#" style="font-size: 1.2vw; letter-spacing: 1.2px;">
                    <- BACK TO ALL OFFERS </a> </div> </div> <!--Fifth div-->
