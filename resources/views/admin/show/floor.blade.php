...
<div class="container-fluid pt-5">
    <h2 class="mb-4">Hotel Floor</h2>
    <!--Create button-->
    <div align=right class="mb-5">
        <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">Create Floor</button>
    </div>
    <table class="table table-bordered floor-datatable datatables-button-formatter" id="floor-datatable">
        <thead>
            <tr>
                <th>Id</th>
                <th>Floor</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 60vw !important; margin: 0px auto;">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="floor_form" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                         <div class="col-lg-8 col-md-8 col-sm-8 container justify-content-center">
                             <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input type="text" class="form-control" name="floor" id="floor" placeholder="Floor Name">
                                </div>
                             </div>
                        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        /* Edit floor starts here  =>EDIT */
        $(document).on('click', '.edit', function() {
            var id = $(this).attr('id');
            $('#form_result').html('');
            $('#formModal').modal('show');
            $.ajax({
                url: "/admin/floor/" + id + "/edit",
                dataType: "json",
                success: function(html) {
                    $('#floor').val(html.data.floor);
        ...
        $('#ok_button').click(function() {
            $.ajax({
                url: "/admin/floor/destroy/" + floor_id,
                beforeSend: function() {
                ...
                success: function(data) {
                    setTimeout(function() {
                        ...
                        $('#floor-datatable').DataTable().ajax.reload(); //Reloads table after deletion
                    }, 2000);
                }
            })
        });
        ...
        $('#floor_form').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            ...
                            $('#floor_form')[0].reset();
                            $('#floor-datatable').DataTable().ajax.reload();
                        }
