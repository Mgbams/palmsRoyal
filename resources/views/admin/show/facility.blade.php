                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="facility_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="checkbox" name="other_facilities[]" value="television"> Télévision <br />
                                <input type="checkbox" name="other_facilities[]" value="desk"> Desk <br />
                                <input type="checkbox" name="other_facilities[]" value="hairdryer"> Hairdryer <br />
                                <input type="checkbox" name="other_facilities[]" value="breakfast_included"> Breakfast included <br />
                            </div>
                        </div>
