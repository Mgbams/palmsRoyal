...
<div class="container-fluid pt-5">
    ...
    <div align=right class="mb-5">
        <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">Create Capacity</button>
    </div>
    <table class="table table-bordered capacity-datatable datatables-button-formatter" id="capacity-datatable">
        <thead>
            <tr>
                <th>Id</th>
                <th>Capacity</th>
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '.delete', function() {
            capacity_id = $(this).attr('id');
            $('#confirmModal').modal('show');
        });

        $('#ok_button').click(function() {
            $.ajax({
                url: "/admin/capacity/destroy/" + capacity_id,
                beforeSend: function() {
                ...
                success: function(data) {
                    setTimeout(function() {
                        ...
                        $('#capacity-datatable').DataTable().ajax.reload(); //Reloads table after deletion
                    }, 2000);
                }
            })
        });
        ...
        $('#capacity_form').on('submit', function(event) {
