...
<div class="pages-stack">
    ...
    <div class="page about-hotel" id="page-home">
        ...
        <div style="width: 50%; margin-top: 100px;" class="about-first-div">
            <h2 class="col-6 offset-6" style="position: relative; top: 5vh;"> Made By palmsRoyal</h2>
        </div>
        <div style="width: 100%; height: 90vh; margin-bottom: 100px; display: flex;" class="macron-div">

            <div style="width: 50%; height: 100%;">
                <div style="width: 80%; height: 40%; position: relative; top: 20vh;" class="about-second-img">
                    <img src="https://cdn.pixabay.com/photo/2020/04/17/12/24/bed-5054985__340.jpg" style="width: 100%; height: 100%;" />
                </div>
            </div>

            <div style="width: 50%; height: 100%; display: flex;">
                <div style="width: 40%; height: 100%; position: relative; left: 6vw; top: 20vh;" class="about-description">
                    <p>
                    ...
                    <div style="position: absolute; left: 2vw; width: 20%; height: 20%;" class="hotel-info-readmore">
                        <div style="position: relative; width: 8vw; top: 10vh; left: .5vw; z-index: 50;" class="read"><a class="special-offers-link read-more-link" href="{{url('/more-space')}}">READ MORE</a></div>
                ...
                <div style="width: 60%; height: 100%; background-color: #f9efea;" class="colored-div"></div>
            </div>
        </div>

        <!--First div-->
        <div style="width: 100%; height: 90vh; margin-top: 100px; display: flex;" class="twin-container">
            <div style="width: 50%; height: 100%;" id="hotel-info-firsttwin">
                <img src="https://cdn.pixabay.com/photo/2020/04/17/12/24/bed-5054985__340.jpg" style="width: 100%; height: 100%;" />
            </div>
            <div style="width: 50%; height: 100%;" id="hotel-info-secondtwin">
                <h2 style="position: relative; right: 35px; top: 70px; font-size: 5vw;" class="hotel-info-secondtwin-header">Conception <br /> Hôtels</h2>
                <p class="col-5 offset-5 hotel-info-secondtwin-paragraph" style="position: relative; top: 100px;" >
                ...
                <div class="special-offers-div" style="position: absolute; left: 68vw; top: 285vh; width: 20%; height: 20%;">
                    <div style="position: relative; top: 10vh; left: .5vw; z-index: 999;"><a class="special-offers-link read-more-link twin-readmore" href="{{url('/more-space')}}">READ MORE</a></div>
        ...
        <!--Third div-->
        <div style="width: 100%; height: 100vh; margin-top: 80px; display: flex;" class="galerie-container">
            ...
            <div style="width: 50%; height: 100vh;" class="gallery-title">
                <h2 class="col-lg-5 offset-lg-2 offset-sm-9 col-sm-12" style="font-size: 4vw;">Galerie</h2>
                <div class="col-4 offset-7 gallery-para">
        ...
        <div class="quartier-container">
            <div style="text-align: center;">
                <h2>Quartier</h2>
            </div>
            <div class="col-5 offset-6 quartier-paragraph" >
        ...
        <div style="margin-top: 120px; height: 100vh; display: flex;" class="hotel-info-partners-container">
            <div style="width: 50%; height: 100vh;" class="partner-left-div-image">
                <div class="multiple-items" style="position: relative; top: 35%; width: 50vw; left: 65%; height: 35vh;">
                    <div style="height: 35vh; width: 30vw;" class="multi-image">
            ...
            <div style="width: 50%; height: 100vh;" class="partners">
