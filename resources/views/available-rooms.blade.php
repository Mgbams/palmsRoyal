...
<div class="pages-stack">
    ...
    <div class="container">
        ...
        <div class="d-flex available-room-second-container">
            <div class="col-md-4 available-rooms-image" style="height: 50vh; padding-left: 0px;">
            ...
            <div class="col-md-8 d-flex justify-content-between available-room-super-container" style="padding-right: 0px;">
                <div>
                ...
                <div class="d-flex flex-column justify-content-between available-best-rate-pay-container">
                    <div class="available-best-rate">
                        <p><input type="radio" checked> Best available rate</p>
                    </div>
                    <div class="d-flex align-items-end available-best-paynow">
