...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto roles-navigation">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwPHoNi80aBAEcV5c8tu4gMl3MLzQG9H7KIQ&usqp=CAU" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwPHoNi80aBAEcV5c8tu4gMl3MLzQG9H7KIQ&usqp=CAU" class="img-circle elevation-2" alt="User Image">
                            <p>
                                {{ Auth::user()->name }}
