    ...
    <div class="pages-stack">
        ...
        <div class="page about-hotel" id="page-home">
            ...
            <div class="rooftop-first-div-background-image" style="height: 85vh; width: 100%; margin-top: 120px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                ...
                <div style="height: 75vh; width: 80%; position: relative; z-index: 1; border: 3px solid blue; display: flex; flex-direction: column;" class="rooftop-first-div-inner-image">
            ...
            <div style="width: 100%; height: 100vh; display:flex;">
                ...
                <div class="eat-drink-morning-second-div-image" style="width: 40%; height: 100%; display: flex; justify-content: center; align-items: center; z-index: 999;">
