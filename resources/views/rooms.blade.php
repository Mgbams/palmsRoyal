...
<div class="pages-stack">
    ...
    <div class="page about-hotel" id="page-home">
        ...
        <div style="width: 100%; padding: 0px; display: flex; flex-wrap: wrap; justify-content: space-between; min-height: 100vh;">
            ...
            <div style="height: 100vh; width: 47%; margin-bottom: 15vh;">
                ...
                <div style="display: flex; justify-content: space-between; width: 100%;">
                    ...
                    <div style="width: 20%;">
                        <i class="fa fa-wifi" style="color: black;"></i>
                        <p>{{ $room->capacity }}m<sup>2</sup></p>
                    </div>
                    @endif
                </div>

                <div style="margin-top: 20px; position:relative; display: flex; flex-direction:column; justify-content: center; align-items:center;">
                    <div style="position: relative; right: 30px; top: 10px; z-index: 50;"><a class="special-offers-link read-more-link" href="{{url('/room/'.$room_links[$room->id])}}">DETAILS</a></div>
