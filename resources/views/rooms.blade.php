...
<body>
    ...
    <div class="pages-stack">
        ...
        <div class="page about-hotel" id="page-home">
            ...
            <div style="width: 100%; padding: 0px; display:flex; justify-content: space-between; height: 100vh;">
                <div style="height: 100%; width: 47%;">
                    <div style="width: 100%;">
                        <img src="https://cdn.pixabay.com/photo/2020/04/17/12/24/bed-5054985__340.jpg" style="height: 65%; width: 100%;" />
                    </div>
                    ...
                    <div style="margin-top: 20px; position:relative; display: flex; flex-direction:column; justify-content: center; align-items:center;">
                        <div style="position: relative; right: 30px; top: 10px;"><a class="special-offers-link read-more-link" href="#">DETAILS</a></div>
                        <div style="position:absolute; left: 180px; top: -32px;">
                            <svg viewBox="0 0 197 112" class="btn-border" style="width: 160px; height: 140px;">
